# CT-0021 v0.3-reconstruction 迭代记录

生成时间: 2026-06-24 16:49:17
...
fused_voxels: 5118493
```

## 输出文件

输出目录: `/mnt/c/Users/zhangyutang/Desktop/CT-EUS血管重建结果/CT-EUS-vessel-pipeline-runs/CT-0021-v0.3-reconstruction`
...
- v0.3 仍是自动候选重建，尚未用人工标注做 Dice/Hausdorff 评价
